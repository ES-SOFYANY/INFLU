...
/**
 * US-060 — Creator messaging (`/creator/messaging`).
 * - Table with Profile, Campaign, Last Message, Actions
 * - Filters: Search, Filter by brand, Filter by status (OPEN/CLOSED)
 * - Detail view: chronological message panel + composer (POST message,
 *   non-empty validation)
 * US-061 — Empty state: EXACT "You don't have any open discussions at the moment."
 */
@Component({
  selector: 'app-creator-messaging-page',
  standalone: true,
  ...
  template: `
    <main id="main" role="main" style="flex:1;padding:var(--space-8);">
      ...
      <p style="color:var(--text-secondary);margin-bottom:1.5rem;">
        Chat with brands and keep track of conversations related to your collaborations.
      </p>
        ...
        @if (loading()) {
          ...
          <div class="card" style="padding:0;" data-testid="msg-empty">
            <div class="empty-state" role="status">
              ...
              <p class="empty-desc">
                When you apply for an opportunity, a conversation with the brand will appear here.
              </p>
...
export class CreatorMessagingPage implements OnInit {
