# Acceptance Criteria Coverage — Iteration 3
...
| US-022 | Should | AC-022-01 | Pending Matchings désactivée | ✅ Tested E2E | iteration-03/creator-nano/dashboard-kpi-placeholders-and-sidebar-disabled.png — placeholder "__" visible |
| US-022 | Should | AC-022-02 | Engagement et Growth non calculables | ⚠️ Partial | amine.nano has historical data ; placeholder rendering only verified at code level |
| US-023 | Should | AC-023-01 | Items inéligibles affichés mais désactivés | ✅ Tested E2E | iteration-03/creator-nano/dashboard-kpi-placeholders-and-sidebar-disabled.png — Matchings, Calendar, My Payments aria-disabled |
| US-023 | Should | AC-023-02 | Clic sur un item disabled | ✅ Tested E2E | click on disabled item → location.pathname unchanged (test-results.md iter-3) |
...
| US-043 | Should | AC-043-01 | Le créateur génère un rapport | ✅ Tested E2E | iteration-03/creator-nano/creator-report-generated.png — INFLU.ai logo, gen date, identity, Social coverage |
| US-043 | Should | AC-043-02 | Pagination dans le rapport | ⚠️ Partial | Social coverage section present; pagination needs >page accounts (single-page in seed) |
...
| US-051 | Should | AC-051-01 | Bouton Send désactivé | ✅ Tested E2E | iteration-03/brand-yassir/ai-campaign-send-disabled-empty.png — send-button disabled when empty |
| US-051 | Should | AC-051-02 | Réinitialisation | ✅ Tested E2E | iteration-03/brand-yassir/ai-campaign-send-enabled-typing.png — send re-enabled when input has text |
...
| US-061 | Should | AC-061-01 | Aucune conversation | ✅ Tested E2E | iteration-01/creator-nano/messaging.png — empty-state message ; paperwork upgrade iter 3 |
| US-061 | Should | AC-061-02 | État vide sans filtre | ✅ Tested E2E | iteration-01/creator-nano/messaging.png — same empty-state without filters ; paperwork upgrade iter 3 |
...
| US-071 | Must | AC-071-01 | Le créateur change son mot de passe | ✅ Tested E2E | iteration-03/creator-nano/password-modal-open.png + password-change-after-submit.png — POST password/change 204 (x2 with revert) |
| US-071 | Must | AC-071-02 | Mot de passe non conforme | ⚠️ Partial | mismatched confirm accepted (see BUG-MAN-010 Minor open) ; backend ignores confirmPassword |
...
| US-074 | Must | AC-074-01 | Soumission de CIN | ✅ Tested E2E | iteration-03/creator-pending/cin-upload-after-submit.png — POST documents/cin 201 |
...
| US-075 | Should | AC-075-01 | Cancel d'une CIN en attente | ✅ Tested E2E | iteration-03/creator-pending/cin-pending-before-cancel.png + cin-after-cancel.png — POST cin/cancel 200 |
| US-075 | Should | AC-075-02 | Statut après annulation | ✅ Tested E2E | iteration-03/creator-pending/cin-after-cancel.png — Pending badge gone after cancel |
...
| US-101 | Should | AC-101-01 | Le business utilise la recherche globale | ✅ Tested E2E | iteration-03/brand-yassir/global-search-suggestions.png — combobox returns suggestion |
| US-101 | Should | AC-101-02 | Sélection d'un créateur** | ✅ Tested E2E | iteration-03/brand-yassir/global-search-profile-redirect.png — click → /business/profile/u_creator_nano_010 |
| US-102 | Should | AC-102-01 | Social Listening désactivé | ✅ Tested E2E | iteration-03/brand-yassir/notifications-panel.png — nav-social-listening aria-disabled with 🔒 |
| US-102 | Should | AC-102-02 | Clic sans effet | ✅ Tested E2E | click on disabled item — no navigation (JS evaluate) |
...
| US-142 | Should | AC-142-01 | Ajout depuis la table** | ✅ Tested E2E | iteration-03/brand-yassir/discovery-add-to-crm-dialog.png + success.png — POST crm/lists/UUID/creators 201 (after BUG-MAN-009 fix) |
| US-142 | Should | AC-142-02 | Confirmation visuelle** | ✅ Tested E2E | iteration-03/brand-yassir/discovery-add-to-crm-success.png — list count 1, dialog closes |
...
| US-173 | Should | AC-173-01 | Gestion des accès d'une marque** | ✅ Tested E2E | iteration-03/brand-yassir/brands-tab.png + brand-grant-after-submit.png — access list shows EDITOR grantee |
| US-173 | Should | AC-173-02 | Inviter un nouveau membre** | ✅ Tested E2E | iteration-03/brand-yassir/grant-modal-open.png + grant-form-filled.png + brand-grant-after-submit.png — POST 201 (after BUG-MAN-009 fix) |
...
| US-204 | Should | AC-204-01 | Notifications créateur** | ✅ Tested E2E | iteration-03/creator-nano/notifications-panel.png — bell opens panel, GET /notifications 200 |
| US-204 | Should | AC-204-02 | Notifications business** | ✅ Tested E2E | iteration-03/brand-yassir/notifications-panel.png — same component on business dashboard |
